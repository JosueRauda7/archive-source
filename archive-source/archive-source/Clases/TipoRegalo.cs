...
namespace archive_source.Clases
{
    class TipoRegalo
    {
        ...
        public void listarTipoRegalo(DataGridView dgv)
        {
            ...
            {
                dt = new DataTable();
                MySqlDataAdapter da = new MySqlDataAdapter("Select nombre from tiporegalo", conexion.cn);
                da.Fill(dt);
                dgv.DataSource = dt;
        ...
        public void listarTipoRegalo(DataGridView dgv, string filtro)
        {
            ...
            {
                dt = new DataTable();
                MySqlCommand comando = new MySqlCommand("Select nombre from tipoRegalo Where nombre like @filtro", conexion.cn);
